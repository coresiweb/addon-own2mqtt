...
class OWNFrameCommand:
    ...
    def send_frame_who_1(self):
        ...
        self.own_instance.write_socket(self.frame)
        response_frames = self.own_instance.read_command_socket()
